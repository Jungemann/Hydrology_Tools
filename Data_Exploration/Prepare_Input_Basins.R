...
Path      <- 'D:/GR2M_PERU/GR2M_saFast_Peru'
Shapefile <- 'Subcuencas_GR2M.shp'
...
# para cada subcuenca de estudio
  ...
  # Read pet data
  pet  <-brick(file.path('1_DATA', PET))
...
## EXPORT EXTRACTED DATA =========================================
  ...
  write.table(df, file=file.path('1_DATA','Inputs_Basins.csv'), sep=',', row.names=F)
