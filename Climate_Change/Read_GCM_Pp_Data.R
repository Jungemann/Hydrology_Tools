# Este scprit lee los archivos netCDF de GCMs y extrae data para puntos de interés
# En caso de procesar datos de temperatura o caudal se debe cambiar FUN=mean en la función aggregate
