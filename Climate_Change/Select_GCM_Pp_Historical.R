# Este script genera gráficos comparrativos de variación estacional, regresión lineal y distribución acumulada
# para la precipitación mensual observada y extraida de GCMs 
